...
Standalone implementation of ENgrid's [Remember Me](https://engrid.4sitestudios.com/docs/v2/remember-me) / [Welcome Back](https://engrid.4sitestudios.com/docs/v2/welcome-back) functionality
...
The behavior of the Welcome Back functionality can be customized via the global `window.WelcomeBackOptions` object, which merges with the default configuration defined in `welcomeback.ts`. The available configuration options are:
...
To implement the Welcome Back functionality on your EN pages:
...
The majority of the implementation is located in `src/lib/welcomeback.ts`
